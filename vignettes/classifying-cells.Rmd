...
SingleCellClassR provides 2 main features:
...
The automatic cell identification by SingleCellClassR matches the traditional cell assignment, ie. the approach based on cell canonical marker expression. Taking a simple example, we use CD19 and CD20 (MS4A1) to identify B cells:
...
We see that the marker expression of B cells exactly overlaps the B cell prediction made by SingleCellClassR.
